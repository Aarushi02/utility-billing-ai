...
All agents (DocumentProcessor, TariffAnalysis, etc.) import these paths
instead of hard-coding directories.
...
# ---------------------------------------------------------------------
# 1) Define the root 'data' directory relative to the project
# ---------------------------------------------------------------------
BASE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../"))
DATA_DIR = os.path.join(BASE_DIR, "data")

# ---------------------------------------------------------------------
# 2) Define sub-directories for different pipeline stages
# ---------------------------------------------------------------------
...
# ---------------------------------------------------------------------
# 3) Ensure all folders exist (creates them automatically if missing)
# ---------------------------------------------------------------------
for folder in [INCOMING_DIR, RAW_DIR, PROCESSED_DIR, SAMPLES_DIR, OUTPUT_DIR]:
    os.makedirs(folder, exist_ok=True)

# ---------------------------------------------------------------------
# 4) Helper function to build safe file paths
# ---------------------------------------------------------------------
...
# ---------------------------------------------------------------------
# 5) Diagnostics (run this file directly to verify folder setup)
# ---------------------------------------------------------------------
